...
import { LearningPlanCard } from "../components/roadmap/LearningPlanCard.jsx";
...
export function Roadmap() {
  ...
  const { roadmapData, nextAction, learningPlan, profile, loading, resetDemo } = useLearner();
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 py-4">
      ...
      {/* Autonomous AI Planner Agent Plan (Generated by n8n + Gemini) */}
